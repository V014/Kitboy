...
sidebar_frame = CTkFrame(master=app, fg_color="#601E88",  width=176, height=650, corner_radius=0)
...
CTkButton(master=sidebar_frame, image=package_img, text="Orders", fg_color="#fff", font=("Arial Bold", 14), text_color="#601E88", hover_color="#eee", anchor="w").pack(anchor="center", ipady=5, pady=(16, 0))
