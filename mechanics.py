...
class Mechanics(CTkScrollableFrame):
    ...
    def show_mechanic_details_view(self, mechanic_id):
        ...
        CTkButton(button_frame, text="Back", command=self.show_mechanics_list_view, fg_color="#601E88", hover_color="#9569AF").pack(side="left")
        CTkButton(button_frame, text="Delete", command=lambda: Utils.delete_record("mechanics", mechanic_id, self.show_mechanics_list_view), fg_color="#601E88", hover_color="#DD4055").pack(padx=10, side="right")
